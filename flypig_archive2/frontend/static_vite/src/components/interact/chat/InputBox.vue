...
/* el-textarea（textarea 类型）默认不撑满 → 强制 100% */
.input-container :deep(.el-textarea),
.input-container :deep(.el-textarea__wrapper) {
  width: 100% !important;
}
.input-container :deep(.el-textarea__inner) {
  background: transparent !important; border: none !important; color: #ccc;
  font-family: inherit; font-size: 13px; line-height: 1.5;
  padding: 10px 12px 4px; min-height: 60px; box-shadow: none !important;
}
.input-container :deep(.el-textarea__inner::placeholder) { color: #555; }
.input-footer {
